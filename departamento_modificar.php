...
<html lang="es">
	...
	<body>
		<div class="container">
			<div class="row">
				<h3 style="text-align:center">DEPARTAMENTO - MODIFICAR REGISTRO</h3>
			</div>
			
			<form class="form-horizontal" method="POST" action="Departamento_actualizar.php" autocomplete="off">
				...
				<input type="hidden" id="id" name="id" value="<?php echo $row['DepartamentoId']; ?>" />
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="departamento_abc.php" class="btn btn-default">Regresar</a>
